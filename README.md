...
`Microsoft SQL Server` · `T-SQL` · `SSMS` · `Power BI Desktop` 
...
4. Open Power BI Desktop → Get Data → SQL Server → point at your database → Import all 6 tables → build relationships (see Step 5 above) → recreate the visuals
